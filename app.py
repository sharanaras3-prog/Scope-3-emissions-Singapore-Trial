...
if page == "Dashboard":
    ...
    with col_a:
        ...
        fig2.update_layout(template="plotly_dark", height=320, margin=dict(l=10, r=10, t=10, b=10),
    ...
    with col_b:
        ...
        fig3.update_layout(template="plotly_dark", height=320, margin=dict(l=10, r=10, t=10, b=10),
                            plot_bgcolor="rgba(0,0,0,0)", paper_bgcolor="rgba(0,0,0,0)")
...
# ---------------------------------------------------------------------------
    ...
    fig.add_trace(go.Scatter(x=forecast_df["month"], y=forecast_df["lower"], fill="tonexty",
                              fillcolor="rgba(45,212,191,0.15)", line=dict(width=0), name="Confidence band"))
...
# ---------------------------------------------------------------------------
    ...
    def reply(q):
        ...
        return f"This month's Singapore Scope 3 emissions are {last_total:,} t CO2e. Ask me about Tuas Port, Jurong Island, a supplier, or a shipping lane."
